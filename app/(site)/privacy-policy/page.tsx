    ...
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-left text-gray-700">
          <p className="mb-4">
            Your privacy is important to us. It is Full-Stack-Kit's policy to respect your privacy
            regarding any information we may collect from you across our website and services.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            data and personal information, feel free to contact us at contact@technologeek.ca.
          </p>
          <p className="mb-4">This policy is effective as of 11 February 2024.</p>
        </div>
      </div>
    </div>
  );
